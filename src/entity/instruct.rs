...
use crate::error::NihilityCommonError::CreateInstructReq;
...
impl InstructEntity {
    ...
    pub fn create_text_type_req(self) -> WrapResult<TextInstruct> {
        match self.instruct {
            ...
            data_type => Err(CreateInstructReq(data_type)),
        }
    }
}
